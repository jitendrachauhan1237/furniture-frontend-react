      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 text-lg mb-12">
            Join thousands of happy customers enjoying the best in furniture shopping.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-6">
            {features.map((item, idx) => (
             <div
  key={idx}
  className="group p-5 bg-white rounded-2xl shadow-lg border hover:shadow-xl hover:border-orange-400 transition duration-300"
>
  <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-center gap-3 md:mb-4">
    ...
    <h4 className="font-semibold text-gray-800 text-lg text-left">{item.title}</h4>
  </div>
  <p className="text-sm text-gray-600">{item.description}</p>
        ...
        <div className="relative w-full max-w-md mx-auto">
          ...
          />
          <div className="absolute -top-6 -left-6 w-28 h-28 bg-orange-400 opacity-60 blur-2xl rounded-full z-0 animate-bounce"></div>
          <div className="absolute -bottom-6 -right-6 w-28 h-28 bg-orange-400 blur-2xl rounded-full z-0 animate-bounce"></div>
        </div>
      </div>
    </section>
  );
